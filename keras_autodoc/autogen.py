...
def get_sublocks(element, clean_module_name, post_process_signature,
                 project_url, exclude):
...
def insert_autogenerated_content(page,
                                 exclude,
                                 clean_module_name,
                                 post_process_signature,
                                 project_url,
                                 ...
                                 dest_dir):
    classes = read_page_data(page, "classes", exclude)

    blocks = []
    for element in classes:
        subblocks = get_sublocks(element, clean_module_name,
                                 post_process_signature, project_url,
                                 exclude)
        blocks.append("\n".join(subblocks))

    methods = read_page_data(page, "methods", exclude)
    ...
    functions = read_page_data(page, "functions", exclude)
...
def generate(
    ...
    for page in pages:
        insert_autogenerated_content(page,
                                     exclude,
                                     clean_module_name,
                                     post_process_signature,
                                     project_url,
